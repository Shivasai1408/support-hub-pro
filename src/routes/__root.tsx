...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [
    ...
    { title: "Helm Support — AI service desk" },
    { name: "description", content: "AI-assisted customer support platform: shared inbox, KPIs, knowledge base and analytics." },
  ], links: [
...
function RootComponent() { const {queryClient}=Route.useRouteContext(); return <QueryClientProvider client={queryClient}><SupportProvider><Outlet/><Toaster richColors position="top-right"/></SupportProvider></QueryClientProvider> }
